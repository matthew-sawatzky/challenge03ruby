...
product2 = Product.new(id: 495, name: "Product 2", description: "Test2", price: 10.00, stock_quantity: 1, category_id: 1, created_at: Time.now, updated_at: Time.now)
if product2.save
...
product3 = Product.new(id: 496, name: "Product 3", description: "Test3", price: 10.00, stock_quantity: 1, category_id: 1, created_at: Time.now, updated_at: Time.now)
if product3.save
